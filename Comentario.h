...
string Comentario::getNombre() const { return nombreUsuario; }

float Comentario::getPuntuacion() const { return puntuacionUsuario; }

string Comentario::getComentario() const { return comentarioUsuario; }
